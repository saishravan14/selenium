...
public class CustomWait2 {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("file:///C:/Users/sai/Downloads/WebDriverWait%20Examples/WebDriverWait%20Examples/ButtonClick.html");
		...
		driver.findElement(By.xpath("//input[@id='otherBtn']")).click();
}
}
